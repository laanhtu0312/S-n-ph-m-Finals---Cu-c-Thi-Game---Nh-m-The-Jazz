...
public class InventoryController : MonoBehaviour
{
    ...
    private void Start()
    {
        dialogue = Resources.FindObjectsOfTypeAll<GameObject>().FirstOrDefault(g => g.CompareTag("startDialogue"));
            ...
            dialogue = Resources.FindObjectsOfTypeAll<GameObject>()
                                 .FirstOrDefault(g => g.CompareTag("startDialogue"));

            if (dialogue == null)
            {
                Debug.LogWarning("Dialogue object with tag 'startDialogue' not found!");
            }
