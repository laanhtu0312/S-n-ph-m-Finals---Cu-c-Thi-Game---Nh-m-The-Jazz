...
public class UI_ShopController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        CreateItemButton(plantsDictionary["Seeds_Corn"], "Seeds_Corn", 100, 0, "Kịch Bản Game Seeds");
        CreateItemButton(plantsDictionary["Seeds_Parsley"], "Seeds_Parsley", 30, 1, "Nhập môn Game Seeds");
        CreateItemButton(plantsDictionary["Seeds_Tomato"], "Seeds_Tomato", 60, 2, "Back-end Game Seeds");
        CreateItemButton(plantsDictionary["Seeds_Strawberry"], "Seeds_Strawberry", 150, 3, "Game 3D seeds");
        CreateItemButton(plantsDictionary["Seeds_Potato"], "Seeds_Potato", 110, 4, "Đồ họa game 3d");

        gameObject.SetActive(false); // Ẩn bảng mua đồ ban đầu
        Hide();
    }
    ...
    // Thêm sự kiện OnMouseDown để mở shop khi click vào cửa hàng
